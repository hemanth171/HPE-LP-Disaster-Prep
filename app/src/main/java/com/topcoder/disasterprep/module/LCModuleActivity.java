...
import com.topcoder.disasterprep.module.lc.LCFragment;

/**
 * The activity for the Leadership and Culture module.
 *
 * @author TCSCODER
 * @version 1.0
 */
public class LCModuleActivity extends ModuleActivity {
    /**
     * The fragment resource ids of the intro screens
     */
    private static final int[] INTRO_FRAGMENTS = {
            R.layout.fragment_lc_intro_1, R.layout.fragment_lc_intro_2
    };
    ...
    private static final int[] FINISH_FRAGMENTS = {
            R.layout.fragment_lc_finish_1, R.layout.fragment_lc_finish_2
    };
    ...
    protected Fragment getModuleFragment(int level, int page) {
        return LCFragment.newInstance(level, page);
    }
