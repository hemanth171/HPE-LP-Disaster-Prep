...
import com.topcoder.disasterprep.module.nr.NRFragment;

/**
 * The activity for the Networks and Relationships module.
 *
 * @author TCSCODER
 * @version 1.0
 */
public class NRModuleActivity extends ModuleActivity {
    /**
     * The fragment resource ids of the intro screens
     */
    private static final int[] INTRO_FRAGMENTS = {
            R.layout.fragment_nr_intro_1, R.layout.fragment_nr_intro_2
    };
    ...
    private static final int[] FINISH_FRAGMENTS = {
            R.layout.fragment_nr_finish_1, R.layout.fragment_nr_finish_2
    };
    ...
    protected Fragment getModuleFragment(int level, int page) {
        return NRFragment.newInstance(level, page);
    }
